...
class AddDeviseToUsers < ActiveRecord::Migration[5.1]
  def self.up
    ...
    remove_column :users, :email_confirmation_requested_at, :datetime
    remove_column :users, :email_confirmed_at, :datetime
    remove_column :users, :password_change_token, :string
    remove_column :users, :password_change_requested_at, :datetime
